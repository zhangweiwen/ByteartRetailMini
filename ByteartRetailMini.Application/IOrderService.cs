...
namespace ByteartRetailMini.Application
{
    public interface IOrderService
    {
        ...
        ShoppingCartDataObject GetShoppingCart(string userName);
        ...
        SalesOrderDataObject Checkout(string userName);
        ...
        IList<SalesOrderDataObject> GetSalesOrdersForUser(int userID);
        ...
        SalesOrderDataObject GetSalesOrder(int orderID);
    }
}